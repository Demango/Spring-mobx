This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and [SPRING INITIALIZR](https://github.com/spring-io/initializr/)
